...
function Form() {
  ...
  return (
    <form className="flex flex-col relative space-y-2 text-black/80 dark:text-white/75">
      {/* text area of where user will enter the post comments on the post */}
      <textarea
        rows="4"
      ...
      {/* input option to enter a photo url */}
      <input
        type="text"
      ...
      <button
        className="absolute bottom-0 right-0 font-medium bg-blue-400
         hover:bg-blue-500 disabled:text-black/40 disabled:bg-white/75 
